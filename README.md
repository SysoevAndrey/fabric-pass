...
| `ROOT_GITHUB_ID` | **Optional** — the numeric GitHub id of this app's single root user; unset means no root user at all. Bootstrap for the future admin roles work (IDEA-011) — nothing in the app reads it yet beyond `lib/root-user.ts`'s `isRootUser` |
